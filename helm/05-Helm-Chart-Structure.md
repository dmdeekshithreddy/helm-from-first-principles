...
- [concepts/chart-structure.md](concepts/chart-structure.md) — deep dive on each file/folder, override precedence, subchart dependencies, `_helpers.tpl`, `NOTES.txt`, and the `helm test` lifecycle.
